...
use WilsonGlasser\Spout\Writer\XLSX\Creator\HelperFactory;
...
use WilsonGlasser\Spout\Writer\XLSX\Manager\WorksheetManagerV2;

/**
 * Class ManagerFactory
 * Factory for managers needed by the XLSX Writer
 */
class ZfExtended_Models_Entity_Spout_ManagerFactory implements ManagerFactoryInterface
{
     ...
     * @return \ZfExtended_Models_Entity_Spout_WorksheetManagerV2
     */
    private function createWorksheetManager(
        ...
        return new \ZfExtended_Models_Entity_Spout_WorksheetManagerV2(
            $optionsManager,
            $rowManager,
            $styleManager,
            $styleMerger,
