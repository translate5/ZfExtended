...
class ZfExtended_Logger_DuplicateHandling
{
     ...
     * @var string
     */
    public const DUPLICATION_BY_MESSAGE = 'message';

    /**
     * recognizes event duplications just by ecode, ignoring content of {variables}
     * @var string
     */
    public const DUPLICATION_BY_ECODE = 'ecode';

    protected static $duplicateConfiguration = [];
     ...
     */
    public static function addDuplicates(array $ecodes, string $mode)
    {
