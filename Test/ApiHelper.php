...
{
    public const PASSWORD = 'asdfasdf';

    public const AUTH_COOKIE_KEY = 'zfExtended';
    ...
    public function getHtmlPage(string $url, array $parameters = [], string $authCookie = null)
    {
        ...
        $http = new Zend_Http_Client(static::$CONFIG['API_URL'] . ltrim($url, '/'), [
    ...
    public function getFile(string $approvalFile, string $class = null, bool $assert = true)
    {
        ...
        $path = join('/', [$this->testRoot, $class, $approvalFile]);
